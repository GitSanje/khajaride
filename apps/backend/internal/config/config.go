...
type WebhookConfig struct {
	ClerkWebhookSigningSecret string `koanf:"clerk_webhook_signing_secret" validate:"required"`
}
...
func LoadConfig() (*Config, error) {
	...
	err := k.Load(env.Provider("KHAJARIDE_", ".", func(s string) string {
		return strings.ToLower(strings.TrimPrefix(s, "KHAJARIDE_"))
	}), nil)
	if err != nil {
	...
	mainConfig.Observability.ServiceName = "khajaride"
