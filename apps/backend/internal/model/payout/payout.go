...
type PayoutAccount struct {
	...
	StripeAccountID       *string    `json:"stripeAccountID,omitempty" db:"stripe_account_id"`
	StripeExternalAccount *string    `json:"stripeExternalAccount,omitempty" db:"stripe_external_account_id"`
